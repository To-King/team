...
!(async () => {
    ...
    let res = [];
    try{res = await getAuthorShareCode('https://raw.githubusercontent.com/ugg999999/Profiles/master/shareCodes/vivo.json');}catch (e) {}
    if(!res){
        try{res = await getAuthorShareCode('https://raw.fastgit.org/ugg999999/Profiles/master/shareCodes/vivo.json');}catch (e) {}
        if(!res){res = [];}
    }
