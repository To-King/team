...
!(async () => {
  ...
  $.updatePkActivityIdRes = await getAuthorShareCode('https://raw.githubusercontent.com/ugg999999/Profiles/master/shareCodes/jd_cityShareCodes.json')
  if (!$.updatePkActivityIdRes) {
    ...
    await $.wait(1000)
    $.updatePkActivityIdRes = await getAuthorShareCode('https://raw.fastgit.org/ugg999999/Profiles/master/shareCodes/jd_cityShareCodes.json')
  }
