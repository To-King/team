...
!(async () => {
    ...
    let res2 = [];
    try{res2 = await getAuthorShareCode('https://raw.githubusercontent.com/ugg999999/Profiles/master/shareCodes/shop.json');}catch (e) {}
    if(!res2){
        try{res2 = await getAuthorShareCode('https://raw.fastgit.org/ugg999999/Profiles/master/shareCodes/shop.json');}catch (e) {}
        if(!res2){res2 = [];}
    }
    res = [...res,...res2]
    if(res.length > 0){
