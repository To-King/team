...
!(async () => {
  ...
  if (HelpAuthorFlag) {
    ...
    if(!$.innerInviteList[0]) $.innerInviteList = await getAuthorShareCode('https://raw.githubusercontent.com/ugg999999/scripts/master/Expired/wealth_island_code_one.json');
